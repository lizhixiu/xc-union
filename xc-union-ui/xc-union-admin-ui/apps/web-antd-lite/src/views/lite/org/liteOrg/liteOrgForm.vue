  ...
  schema: [
    ...
    },
    {
      ...
      componentProps: {
        // 获取配置类型的API
        api: () =>
          requestClient.post('/public/para/comList?classCode=SYS_ORG_TYPE'),
        labelField: 'nameTxt',
        valueField: 'codeTxt',
        placeholder: '请选择配置类型',
...
async function handleSave() {
  ...
  try {
    ...
    const context = {
      ...
      saveConfig: {
        insertAction: '/lite/org/liteOrg/insert',
        updateAction: '/lite/org/liteOrg/update',
