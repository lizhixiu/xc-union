...
const handleAdd = () => {
  const context: any = {};
  context.title = '组织表|新增';
  context.src = '/src/views/lite/org/liteOrg/liteOrgForm.vue';
...
const handleReorder = () => {
  const context: any = {};
  context.param = { pid: selectedNode.value?.id };
  context.postAction = '/lite/org/liteOrg/reorder';
...
<template>
  <ColPage auto-content-height title="" v-bind="pageProps">
    ...
    <CommonTable
      ...
      api-endpoint="/lite/org/liteOrg/page"
