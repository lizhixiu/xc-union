...
/**
 * 基本信息表单配置
 * 包含主键、登录账号、失败密码、是否删除、失败信息、登录类型、浏览器、操作系统、地理位置、ip地址、token、创建人ID、创建人、创建时间、企业ID等字段
 */
...
async function handleSave() {
  ...
  try {
    ...
    const context = {
      ...
      saveConfig: {
        insertAction: '/lite/log/liteLogLogin/insert',
        updateAction: '/lite/log/liteLogLogin/update',
