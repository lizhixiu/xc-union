...
const handleAdd = () => {
  ...
  context.src = '/src/views/lite/user/liteUser/liteUserForm.vue';
...
const handleReorder = () => {
  const context: any = {};
  context.param = { pid: selectedNode.value?.id };
  context.postAction = '/lite/user/liteUser/reorder';
...
<template>
  <ColPage auto-content-height title="" v-bind="pageProps">
    ...
    <CommonTable
      ...
      api-endpoint="/lite/user/liteUser/page"
