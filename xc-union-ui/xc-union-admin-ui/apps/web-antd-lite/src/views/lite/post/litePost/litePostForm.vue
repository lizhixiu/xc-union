  ...
  schema: [
    ...
    },
    {
      ...
      componentProps: {
        // 获取配置类型的API
        api: () =>
          requestClient.post('/public/para/comList?classCode=SYS_POST_TYPE'),
        labelField: 'nameTxt',
        valueField: 'codeTxt',
        placeholder: '请选择配置类型',
...
async function handleSave() {
  ...
  try {
    ...
    const context = {
      ...
      saveConfig: {
        insertAction: '/lite/post/litePost/insert',
        updateAction: '/lite/post/litePost/update',
