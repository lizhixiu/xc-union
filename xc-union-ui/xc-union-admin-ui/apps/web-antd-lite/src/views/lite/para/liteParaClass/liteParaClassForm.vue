  ...
  schema: [
    {
      ...
      componentProps: {
        ...
        api: () =>
          requestClient
            .post('/lite/para/liteParaClass/comTree')
            .then((res) => res.list),
        labelField: 'nameTxt',
        valueField: 'id',
    ...
    },
    {
      ...
      componentProps: {
        // 获取参数类型的API
        api: () =>
          requestClient.post('/public/para/comList?classCode=SYS_PARA_TYPE'),
        labelField: 'nameTxt',
        valueField: 'codeTxt',
        placeholder: '请选择参数类型',
...
async function handleSave() {
  ...
  try {
    ...
    const context = {
      ...
      saveConfig: {
        insertAction: '/lite/para/liteParaClass/insert',
        updateAction: '/lite/para/liteParaClass/update',
