...
const handleAdd = () => {
  ...
  context.src = '/src/views/lite/para/liteParaClass/liteParaClassForm.vue';
...
const handleReorder = () => {
  const context: any = {};
  context.param = { pid: selectedNode.value?.id };
  context.postAction = '/lite/para/liteParaClass/reorder';
...
<template>
  <ColPage auto-content-height title="" v-bind="pageProps">
    ...
    <CommonTable
      ...
      api-endpoint="/lite/para/liteParaClass/page"
