package com.lite.union.client.config;

import com.jfinal.config.*;
import com.jfinal.json.FastJsonFactory;
import com.jfinal.kit.PropKit;
import com.jfinal.template.Engine;
import com.lite.union.client.module.dtk.DtkConfig;
import com.lite.union.client.module.dtk.DtkModule;
...
public class ClientConfig extends JFinalConfig {
    ...
    public void configPlugin(Plugins me) {
        ...
        dtkConfig.setAppKey(PropKit.get("lite.union.dtk.appKey"));
        dtkConfig.setAppSecret(PropKit.get("lite.union.dtk.secret"));
        dtkConfig.setDebug(PropKit.getBoolean("lite.union.dtk.debug", false));
        if (PropKit.get("lite.union.dtk.apiUrl")!=null) {
            dtkConfig.setApiUrl(PropKit.get("lite.union.dtk.apiUrl"));
        }
