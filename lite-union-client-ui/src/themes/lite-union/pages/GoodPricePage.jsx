import { ClockCountdown, FireSimple } from '@phosphor-icons/react';
...
export default function HotDealsRankPage() {
  return (
        ...
        <div className="rounded-3xl overflow-hidden border border-[#ffaea6] shadow-[0_10px_24px_rgba(245,66,66,0.2)]">
          <div className="p-4 md:p-5 bg-[linear-gradient(135deg,#ff4f4f_0%,#f33c3c_100%)] text-white">
            <div className="flex items-center justify-between">
              <div className="text-[22px] font-bold tracking-wide">神价好货</div>
              <button className="h-8 px-3 rounded-lg bg-white/20 text-[12px]">搜神价</button>
            </div>
